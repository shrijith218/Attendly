...
router.post('/scan', async (req, res) => {
  // Same as your attendance scanner backend code, with changed path prefix
  try {
    ...
    // Fetch student record (no face_descriptor select)
    const { data: student, error: fetchError } = await supabase
      .from('students')
      .select('admission_number, name, class_sec')
...
// GET /attendance/download-excel?date=YYYY-MM-DD
